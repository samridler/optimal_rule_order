...
@enum SolutionMethod none thumb insert repeatinsert swap reinsert ip remtime
...
@time ruleevalorders[remtime] = estimatedremainingtimeheuristic(ruleevaltimes, ruleevalpass)
